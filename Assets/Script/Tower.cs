...
public class Tower: MonoBehaviour {
	...
	public void ShootTarget() {
		...
		if(_runningShootDelay <= 0f) {
			...
			Bullet bullet = LevelManager.levelManagerInstance.GetBulletFromPool( _bulletPrefab );
	...
	// Membuat tower selalu melihat ke arah musu
	...
	public Sprite towerHeadIcon {
		get => _towerHead.sprite;
	}
